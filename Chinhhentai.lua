...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://136455755449003",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Youtube: @Chinhbuiminhchinh",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=136455755449003";
v24.Parent = v23;
...
elseif Sea3 then
    v16.Raid:AddButton({
        Title = "Bay Đến Chỗ Có gái ngực to ",
        Description = "",
        Callback = function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(- 5075.50927734375, 314.5155029296875, - 3150.0224609375));
            Tween2(CFrame.new(- 5017.40869, 314.844055, - 2823.0127, - 0.925743818, 4.482175e-8, - 0.378151238, 4.5550315e-9, 1, 1.0737756e-7, 0.378151238, 9.768162e-8, - 0.925743818));
...
v16.Misc:AddButton({
    Title = "Đổi Máy Chủ có người địt nhau",
    Description = "",
    Callback = function()
        Hop();
    end
